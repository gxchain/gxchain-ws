package com.gxchain.common.ws.client.graphenej.objects;
...
import com.gxchain.common.ws.client.graphenej.interfaces.ByteSerializable;
import com.gxchain.common.ws.client.graphenej.interfaces.JsonSerializable;
import com.gxchain.common.ws.client.graphenej.operations.BaseOperation;
import com.gxchain.common.ws.client.graphenej.operations.LimitOrderCreateOperation;
...
public class Transaction implements ByteSerializable, JsonSerializable {
    ...
    public static class TransactionSerializer implements JsonSerializer<Transaction> {
        ...
        @Override public JsonElement serialize(Transaction transaction, Type type, JsonSerializationContext jsonSerializationContext) {
    ...
    public static class TransactionDeserializer implements JsonDeserializer<Transaction> {
        ...
        @Override public Transaction deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
